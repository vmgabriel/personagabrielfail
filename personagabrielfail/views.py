...
class StudentsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabrielfails:studentss")
...
def delete_students_view(request, pk):
    ...
    students.delete()
    return redirect("personagabrielfails:studentss")
...
class _8u11ectsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personagabrielfails:_8u11ectss")
...
def delete__8u11ects_view(request, pk):
    ...
    _8u11ects.delete()
    return redirect("personagabrielfails:_8u11ectss")
